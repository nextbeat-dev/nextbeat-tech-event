...
「基本設計さえ握れば、AI（Claude Code / Codex）で"使えるもの"がぱっと立ち上がってしまう」体験を持ち帰る。
...
1. 「基本設計（規則表）さえ握れば、AI で実装がぱっと立ち上がる」という開発体験
