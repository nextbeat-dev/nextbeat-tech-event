...
このリポジトリはNextbeatの社外向け技術イベントのためリポジトリです。各イベントの資料は以下のように構成されていますので、必要に応じて事前にダウンロードしておいてください。

- [ゼロから始めるScala体験会](scala-trial-202504/index.md)
  - [イベント資料](scala-trial-202504/index.pdf)
  - [配布資料](scala-trial-202504/shared.pdf)
